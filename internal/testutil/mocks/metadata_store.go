...
func (m *MockMetadataStore) Reset() {
	...
	m.createUserErr = nil
	m.getUserErr = nil
	m.createAccessKeyErr = nil
	m.getAccessKeyErr = nil
	m.createPolicyErr = nil
	m.getPolicyErr = nil
	m.updateUserErr = nil
	m.deleteUserErr = nil
	m.deleteAccessKeyErr = nil
	m.updatePolicyErr = nil
	m.deletePolicyErr = nil
	m.addUploadPartErr = nil
	m.completeMultipartErr = nil
